 ...
 */
final class Version20190318102325 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE uptime_result ADD fail_reason VARCHAR(1024) DEFAULT NULL, ADD status VARCHAR(255) NOT NULL, DROP error_message, CHANGE http_status http_status INT DEFAULT NULL, CHANGE load_time_in_ms load_time_in_ms NUMERIC(10, 7) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE uptime_result ADD error_message VARCHAR(1024) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci, DROP fail_reason, DROP status, CHANGE http_status http_status INT DEFAULT NULL, CHANGE load_time_in_ms load_time_in_ms NUMERIC(10, 7) DEFAULT \'NULL\'');
