 ...
 */
final class Version20190329185627 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE uptime_result (id INT AUTO_INCREMENT NOT NULL, website_id INT NOT NULL, http_status INT DEFAULT NULL, load_time_in_ms NUMERIC(10, 7) DEFAULT NULL, fail_reason VARCHAR(1024) DEFAULT NULL, status VARCHAR(255) NOT NULL, date_time_created DATETIME NOT NULL, INDEX IDX_ADFE37E818F45C82 (website_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE website (id INT AUTO_INCREMENT NOT NULL, domain VARCHAR(255) NOT NULL, ip VARCHAR(255) DEFAULT NULL, port INT DEFAULT NULL, should_scan_tls TINYINT(1) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
